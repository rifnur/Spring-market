...
public class LoginSteps {
    ...
    @When("^I click create brands$")
    public void iClickOnCreateBrandButton() throws Throwable {
        WebElement webElement = webDriver.findElement(By.id("btn-create-brand"));
        webElement.click();
        Thread.sleep(2000);
    }

    @When("^I add brand")
    public void iAddBrand() throws Throwable {
        WebElement webElement = webDriver.findElement(By.id("name"));
        webElement.sendKeys("Бренд 3");
        Thread.sleep(2000);
    }

    @When("^I save brands$")
    public void iSaveBrandButton() throws Throwable {
